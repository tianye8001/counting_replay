...
// Macro to plot left scaler plots
 ...
 char ccutUPQ[800],ccutDNQ[800];
  ...
  sprintf(ccutUPQ,"fEvtHdr.fEvtType==1 && P.upQadcR>500 && ((R.tr.x+R.tr.th*0.9)>-0.16 && (R.tr.x+R.tr.th*0.9)<0.16) && ((R.tr.y+R.tr.ph*0.9)>-0.04 && (R.tr.x+R.tr.th*0.9)<0.04)");

  sprintf(ccutDNQ,"fEvtHdr.fEvtType==1 && P.loQadcR>600 && ((R.tr.x+R.tr.th*1.05)>-0.16 && (R.tr.x+R.tr.th*1.05)<0.16) && ((R.tr.y+R.tr.ph*1.05)>-0.04 && (R.tr.x+R.tr.th*1.05)<0.04)");
/*
...
// T->Draw("R.tr.y+R.tr.ph*0.9:R.tr.x+R.tr.th*0.9>>UPQProj(100,-0.05,0.05,200,-0.1,0.2)",ccutUPQ,"P.upQadcR");
...
// T->Draw("R.tr.y+R.tr.ph*1.05:R.tr.x+R.tr.th*1.05>>DNQProj(100,-0.05,0.05,200,-0.1,0.2)",ccutDNQ,"P.loQadcR");
 DNQProj = (TH2F *)gDirectory->Get("DNQProj");

 TCanvas *c10 = new TCanvas("c10","c10",1000,1000);
 c10->Divide(1,2);
 c10->cd(1);
 UPQProj->SetTitle("Projection of VDC track on UPQ Plane");
 UPQProj->GetYaxis()->SetTitle("Dispersive direction (m)");
 UPQProj->GetXaxis()->SetTitle("Nondispersive direction (m)");
 UPQProj->Draw("COLZ");
 c10->cd(2);
 DNQProj->SetTitle("Projection of VDC track on DNQ plane");
