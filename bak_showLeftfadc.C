...
// Macro to plot left scaler plots
 ...
 char ccutUPQ[800],ccutDNQ[800];
  ...
  sprintf(ccutUPQ,"fEvtHdr.fEvtType==1 && ((L.tr.x+L.tr.th*0.9)>-0.16 && (L.tr.x+L.tr.th*0.9)<0.16) && ((L.tr.y+L.tr.ph*0.9)>-0.04 && (L.tr.x+L.tr.th*0.9)<0.04)");

  sprintf(ccutDNQ,"fEvtHdr.fEvtType==1 && ((L.tr.x+L.tr.th*1.05)>-0.16 && (L.tr.x+L.tr.th*1.05)<0.16) && ((L.tr.y+L.tr.ph*1.05)>-0.04 && (L.tr.x+L.tr.th*1.05)<0.04)");
...
// TH1F *FBADC_S0A = new TH1F("S0A","S0A",1700,300,2000); 
 T->Draw("P.S0BtdcL>>FBTDC_S0B",ctrig1);
 FBTDC_S0B = (TH1F *)gDirectory->Get("FBTDC_S0B");
 T->Draw("P.S0AtdcL>>FBTDC_S0A",ctrig1);
 FBTDC_S0A = (TH1F *)gDirectory->Get("FBTDC_S0A");
 T->Draw("P.S0BadcL>>FBADC_S0B",ctrig1);
 FBADC_S0B = (TH1F *)gDirectory->Get("FBADC_S0B");
 T->Draw("P.S0AadcL>>FBADC_S0A",ctrig1);
 FBADC_S0A = (TH1F *)gDirectory->Get("FBADC_S0A");

 T->Draw("P.fadcS0AL>>FADC_S0B",ctrig1);
 FADC_S0B = (TH1F *)gDirectory->Get("FADC_S0B");
 T->Draw("P.fadcS0BL>>FADC_S0A",ctrig1);
 FADC_S0A = (TH1F *)gDirectory->Get("FADC_S0A");


 T->Draw("P.S3tdcL>>FBTDC_S3",ctrig2);
 FBTDC_S3 = (TH1F *)gDirectory->Get("FBTDC_S3");
 T->Draw("P.S3adcL>>FBADC_S3",ctrig2);
 FBADC_S3 = (TH1F *)gDirectory->Get("FBADC_S3");

 T->Draw("P.QLIfadcS0B>>FADC_S0B",ctrig1);
 FADC_S0B = (TH1F *)gDirectory->Get("FADC_S0B");
 T->Draw("P.QLIfadcS0A>>FADC_S0A",ctrig1);
 FADC_S0A = (TH1F *)gDirectory->Get("FADC_S0A");

 T->Draw("P.QLIfadcS3>>FADC_S3",ctrig2);
 ...
 T->Draw("P.upQadcL>>FBADC_UQ",ctrig4);
 FBADC_UQ = (TH1F *)gDirectory->Get("FBADC_UQ");
 T->Draw("P.loQadcL>>FBADC_DQ",ctrig5);
 ...
 //T->Draw("R.tr.y+R.tr.ph*0.9:R.tr.x+R.tr.th*0.9>>UPQProj(100,-0.05,0.05,200,-0.1,0.2)",ccutUPQ);
...
// T->Draw("R.tr.y+R.tr.ph*1.05:R.tr.x+R.tr.th*1.05>>DNQProj(100,-0.05,0.05,200,-0.1,0.2)",ccutDNQ);
