...
// TH2F *scaler_S0B = new TH1F("scaler_S0B","S0B rate vs clock",1700,300,2000);
 ...
 T->Draw("P.upScitdcL>>FBTDC_S0B");
 FBTDC_S0A = (TH1F *)gDirectory->Get("FBTDC_S0B");
 T->Draw("P.loScitdcL>>FBTDC_S0A");
 FBTDC_S0B = (TH1F *)gDirectory->Get("FBTDC_S0A");
 T->Draw("P.upSciadcL>>FBADC_S0B");
 FBADC_S0A = (TH1F *)gDirectory->Get("FBADC_S0B");
 T->Draw("P.loSciadcL>>FBADC_S0A");
 FBADC_S0B = (TH1F *)gDirectory->Get("FBADC_S0A");
 T->Draw("P.upSciadcL:0.5*(P.upScitdcL-P.loScitdcL)>>FBS0B_ADCDiffTDC");
 FBS0A_ADCDiffTDC = (TH2F *)gDirectory->Get("FBS0B_ADCDiffTDC");
 T->Draw("P.loSciadcL:0.5*(P.upScitdcL-P.loScitdcL)>>FBS0A_ADCDiffTDC");
 FBS0B_ADCDiffTDC = (TH2F *)gDirectory->Get("FBS0A_ADCDiffTDC");
 T->Draw("0.5*(P.upScitdcL-P.loScitdcL)>>FBS0_DiffTDC");
 FBS0_DiffTDC = (TH1F *)gDirectory->Get("FBS0_DiffTDC");

 T->Draw("L.vdc.u1.time:L.vdc.u1.wire>>VDC_u1");
 VDC_u1 = (TH2F *)gDirectory->Get("VDC_u1");
 T->Draw("L.vdc.v1.time:L.vdc.v1.wire>>VDC_v1");
 VDC_v1 = (TH2F *)gDirectory->Get("VDC_v1");
 T->Draw("L.vdc.u2.time:L.vdc.u2.wire>>VDC_u2");
 VDC_u2 = (TH2F *)gDirectory->Get("VDC_u2");
 T->Draw("L.vdc.v2.time:L.vdc.v2.wire>>VDC_v2");
 ...
 T->Draw("L.vdc.u1.time>>VDCTDC_u1");
 VDCTDC_u1 = (TH1F *)gDirectory->Get("VDCTDC_u1");
 T->Draw("L.vdc.v1.time>>VDCTDC_v1");
 VDCTDC_v1 = (TH1F *)gDirectory->Get("VDCTDC_v1");
 T->Draw("L.vdc.u2.time>>VDCTDC_u2");
 VDCTDC_u2 = (TH1F *)gDirectory->Get("VDCTDC_u2");
 T->Draw("L.vdc.v2.time>>VDCTDC_v2");
 VDCTDC_v2 = (TH1F *)gDirectory->Get("VDCTDC_v2");


 T->Draw("L.vdc.u1.time:0.5*(P.upScitdcL-P.loScitdcL)>>VDC_u1_S0");
 VDC_u1_S0 = (TH2F *)gDirectory->Get("VDC_u1_S0");
 T->Draw("L.vdc.v1.time:0.5*(P.upScitdcL-P.loScitdcL)>>VDC_v1_S0");
 VDC_v1_S0 = (TH2F *)gDirectory->Get("VDC_v1_S0");
 T->Draw("L.vdc.u2.time:0.5*(P.upScitdcL-P.loScitdcL)>>VDC_u2_S0");
 VDC_u2_S0 = (TH2F *)gDirectory->Get("VDC_u2_S0");
 T->Draw("L.vdc.v2.time:0.5*(P.upScitdcL-P.loScitdcL)>>VDC_v2_S0");
