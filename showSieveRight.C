...
// http://hallaweb/podd/doc/variables.html
 ...
 sprintf(ctrig,"fEvtHdr.fEvtNum<70000&&(fEvtHdr.fEvtType==1||fEvtHdr.fEvtType==5)");
...
// T->Draw("R.tr.y[0]+0.9*R.tr.ph[0]", "abs(R.tr.y[0]+0.9*R.tr.ph[0])<0.1");
 ...
 TH2F *hsieve = new TH2F("hsieve","Target theta-phi (theta vertical)",200,-0.05,0.05,200,-0.15,0.15);
