...
cout << "Cuts used : "<<endl;
 ...
 TCanvas c0;
//TCut ccut="abs(R.tr.y[0]+1.0*R.t.ph[0])<0.05 && abs(R.tr.y[0]+0.0*R.tr.ph[0])<0.05 && abs(R.tr.x[0])<0.1 && abs(R.tr.x[0]-0.02)<0.1 && abs(R.tr.ph[0])<0.01"
...
cout << ccut << endl;
 ...
 TH2F *htgthph = new TH2F("htgthph","",200,-0.1,0.035,200,-0.17,0.25);
 //TH2F *htgthph = new TH2F("htgthph","Target theta-phi (theta vertical)",200,-0.01,0.035,200,-0.04,0.04);


T->Draw("L.tr.x[0]+0.2*L.tr.th[0]:L.tr.y[0]+0.2*L.tr.ph[0]>>htgthph",cut1,"colz");
