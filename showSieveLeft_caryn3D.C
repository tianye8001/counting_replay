...
TCut hutcut="L.tr.x[0]>=-0.05 && L.tr.x[0]<=0.1  && L.tr.y[0]<=0.1 && L.tr.y[0]>=-0.05&& L.tr.th[0]>=-0.02 && L.tr.th[0]<=0.02 && L.tr.ph[0]>=-0.04 && L.tr.ph[0]<=0.1"; //cut on transport coordinates in detector hut
...
c1.SetLogz();
TH2F *htgthph= new TH2F("htgthph","",200,-0.04,0.04,200,-0.1,0.1);
