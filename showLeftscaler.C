...
// TH2F *scaler_S0B = new TH1F("scaler_S0B","S0B rate vs clock",1700,300,2000);
 ...
 TSLeft->Draw("LeftS0A_r:LeftLclock>>scaler_S0A","evcount>5");
 scaler_S0A = (TH2F *)gDirectory->Get("scaler_S0A");
 TSLeft->Draw("LeftS0B_r:LeftLclock>>scaler_S0B","evcount>5");
 scaler_S0B = (TH2F *)gDirectory->Get("scaler_S0B");
 TSLeft->Draw("LeftS3_r:LeftLclock>>scaler_S3","evcount>5");
 scaler_S3 = (TH2F *)gDirectory->Get("scaler_S3");
 TSLeft->Draw("LeftUQ_r:LeftLclock>>scaler_UQ","evcount>5");
 scaler_UQ = (TH2F *)gDirectory->Get("scaler_UQ");
 TSLeft->Draw("LeftDQ_r:LeftLclock>>scaler_DQ","evcount>5");
 scaler_DQ = (TH2F *)gDirectory->Get("scaler_DQ");
 TSLeft->Draw("LeftAT1_r:LeftLclock>>scaler_AT1","evcount>5");
 scaler_UQ = (TH2F *)gDirectory->Get("scaler_AT1");
 TSLeft->Draw("LeftAT2_r:LeftLclock>>scaler_AT2","evcount>5");
 scaler_DQ = (TH2F *)gDirectory->Get("scaler_AT2");

 TSLeft->Draw("LeftT1_r:LeftLclock>>scaler_T1","evcount>5");
 scaler_T1 = (TH2F *)gDirectory->Get("scaler_T1");
 TSLeft->Draw("LeftT2_r:LeftLclock>>scaler_T2","evcount>5");
 scaler_T2 = (TH2F *)gDirectory->Get("scaler_T2");
 TSLeft->Draw("LeftT3_r:LeftLclock>>scaler_T3","evcount>5");
 scaler_T3 = (TH2F *)gDirectory->Get("scaler_T3");
 TSLeft->Draw("LeftT4_r:LeftLclock>>scaler_T4","evcount>5");
 scaler_T4 = (TH2F *)gDirectory->Get("scaler_T4");
 TSLeft->Draw("LeftT5_r:LeftLclock>>scaler_T5","evcount>5");
 scaler_T5 = (TH2F *)gDirectory->Get("scaler_T5");
 TSLeft->Draw("LeftT6_r:LeftLclock>>scaler_T6","evcount>5");
 scaler_T6 = (TH2F *)gDirectory->Get("scaler_T6");
 TSLeft->Draw("LeftLclock_r:LeftLclock>>scaler_T8","evcount>5");
 ...
 scaler_AT2->Draw("p*");
 c1->SaveAs("LeftDetectors_rate.pdf");
